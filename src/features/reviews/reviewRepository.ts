import type { CrudRepository, EntityId, ListResult } from "our-lib";
...
export class InMemoryReviewRepository implements CrudRepository<ReviewRecord, ReviewInput, ReviewInput> {
