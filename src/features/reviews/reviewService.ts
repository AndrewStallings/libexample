...
import { reviewInputSchema, type ReviewInput, type ReviewRecord } from "@/features/reviews/reviewSchemas";

export const createReviewService = (
  repository: CrudRepository<ReviewRecord, ReviewInput, ReviewInput>,
  logger: AuditLogger,
) => {
